...
class Case(db.Model):
    ...
    func_cases = db.relationship('FuncCase', backref='case', lazy=True)
...
class FuncCase(db.Model):
    ...
    def __repr__(self) -> str:
        return f"id: {self.id}, case_id: {self.case_id}, case_name: {self.case_name}, case_belong_module: {self.case_belong_module}, case_step: {self.case_step}, case_except_result: {self.case_except_result}, case_state: {self.case_state}, case_comment: {self.case_comment}, create_time: {self.create_time}, update_time: {self.update_time}"
